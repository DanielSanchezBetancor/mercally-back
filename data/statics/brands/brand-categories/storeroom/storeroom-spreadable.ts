...
const StoreRoomSpreadableBrands: TBrand[] = [
  ...
  {
    name: "Tropical",
    pattern: /(?!refresco|leche)(?:\s|^)tropical(?!\srexona)/gi,
  },
  {
    name: "Abbaye D'aulne",
  ...
  {
    name: "Corona",
    pattern: /coron(?:a|ita)(?<!\sblanca)/gi,
  },
  {
    name: "Grimbergen",
  ...
  },
  {
    ...
    pattern: /ladr[oó]n de manzanas/gi,
  },
  {
    name: "Magners",
    pattern: /magners/gi,

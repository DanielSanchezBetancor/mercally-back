...
import VegetalDrinks from "./vegetal-drinks";

const Drinks: TBrand[] = [
  {
    name: "Molen Bier",
    pattern: /molen bier/gi,
  },
  {
    name: "Bifrutas",
    pattern: /bifrutas/gi,
  ...
  {
    name: "La Castellana",
    pattern: /(?:la\s)?castellana(?:\s|$)(?!vegecampo)/gi,
  },
  {
    name: "Chinchón",
  ...
  },
  {
    ...
    pattern: /la\svieja\sf[aá]brica|vieja fabric|lvf/gi,
  },
  {
    name: "El apicultor",
